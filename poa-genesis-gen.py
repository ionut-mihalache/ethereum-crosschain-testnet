...
if len(sys.argv) < 5:
    print("Usage: python poa-genesis-gen.py nodes_path config_file account_file extra_allocation_file genesis_file_name")
    sys.exit(1)
...
genesis_file_name = sys.argv[6] if len (sys.argv) > 6 else "seed_data/genesis.json"
...
def exportGenesis(consortium, chainId):
    ...
    with open(genesis_file_name, "w") as outfile:
